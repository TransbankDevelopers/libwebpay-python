...
def init(request):
	...
	request = "<p style='font-size: 100%; background-color:lightyellow;'><strong>request</strong><br><br><br/>"+ str(request_dict) +", "+ str(stores) +"</p>"
...
def end(request):
	...
	if (request.POST.get('token_ws') != None):
		...
		nullify = nullify + "<input type='submit' value='Anular Transacci&oacute;n &raquo;'></form>";
