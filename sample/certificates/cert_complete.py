...
class certDictionary():
	...
	def dictionaryCert():
		...
		certificate['private_key'] = dir+'/integracion_complete/597020000545.key'
		
		""" Certificado Publico: Configura tu ruta absoluta """
		certificate['public_cert'] = dir+'/integracion_complete/597020000545.crt'
		
		""" Certificado Privado: COnfigura tu ruta absoluta """
		certificate['webpay_cert'] = dir+'/integracion_complete/tbk.pem'
		
		""" Codigo Comercio """
		certificate['commerce_code'] = '597020000545'
