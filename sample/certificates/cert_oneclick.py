...
class certDictionary():
	...
	def dictionaryCert():
		...
		certificate['private_key'] = dir+'/integracion_oneclick/597020000547.key'

		""" Certificado Publico: Configura tu ruta absoluta """
		certificate['public_cert'] = dir+'/integracion_oneclick/597020000547.crt'

		""" Certificado Privado: COnfigura tu ruta absoluta """
		certificate['webpay_cert'] = dir+'/integracion_oneclick/tbk.pem'

		""" Codigo Comercio """
		certificate['commerce_code'] = '597020000547'
